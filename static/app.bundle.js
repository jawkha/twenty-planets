...
var Cars = function (_React$Component) {
  ...
  function Cars() {
    ...
    _this.editCar = _this.editCar.bind(_this);
    return _this;
  }
  ...
  _createClass(Cars, [{
    ...
    value: function toggleEditMode() {
      ...
      var editMode = this.state.editMode ? false : true;
...
var CarForm = function (_React$Component) {
  ...
  _createClass(CarForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      this.props.editMode ? this.props.editCar({
